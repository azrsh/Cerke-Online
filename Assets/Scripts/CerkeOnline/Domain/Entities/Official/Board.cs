...
namespace Azarashi.CerkeOnline.Domain.Entities.Official
{
    public class Board : IBoard
    {
        ...
        bool isLocked = false;
        public void MovePiece(Vector2Int startPosition, Vector2Int endPosition, IPlayer player, IValueInputProvider<int> valueProvider, Action<bool, IPiece> callback)
        {
            if (isLocked) return;
            ...
            isLocked = true;
            callback += (isSuccess, gottenPiece) => { isLocked = false; }; 
