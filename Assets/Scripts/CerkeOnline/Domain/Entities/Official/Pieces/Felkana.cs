...
namespace Azarashi.CerkeOnline.Domain.Entities.Official.Pieces
{
    public class Felkana : DefaultPiece
    {
        ...
        public Felkana(int color, Vector2Int position, IPlayer owner, IExpandingMoveFieldChecker fieldChecker) : base(position, color, owner, Terminologies.PieceName.Felkana, fieldChecker)
        {
